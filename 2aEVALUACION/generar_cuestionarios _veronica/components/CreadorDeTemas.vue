...
export default {
    ...
    return {
      ...
      preguntas: [
        ...
        },
        {
          ...
          tema: 1,
          pregunta:
            "¿Cuál es la frase más famosa del personaje de Darth Vader?",
          correcta: "4",
        ...
        },
        {
          ...
          tema: 2,
          pregunta:
            "¿Qué modelo es el auto donde Marty y Doc viajan en el tiempo?",
          correcta: "2",
          _1: "Mustang",
          _2: "Delorean",
          _3: "Honda",
        ...
        },
        {
          ...
          tema: 2,
          pregunta:
            "Cuando Marty viaja al pasado y se encuentra con su madre de joven, ¿cómo le dice que se llama?",
          correcta: "3",
          _1: "David",
          _2: "Bob",
          _3: "Calvin",
        ...
        },
        {
          ...
          tema: 2,
          pregunta:
            "¿Qué canción tocaba McFly en el baile de instituto de la película?",
          correcta: "4",
  ...
  methods: {
    agregarTema(nuevoTema) {
      if (
        !this.temas.some(
          (t) => t.nombre.toLowerCase() === nuevoTema.toLowerCase()
        )
      ) {
        const id = this.temas.length + 1;

        this.temas.push({ id, nombre: nuevoTema });
      }
    },
    agregarPregunta(temaId, enunciado, opciones, correcta) {
      const tema = this.temas.find((t) => t.id === temaId);

      if (tema) {
        this.preguntas.push({ temaId, enunciado, opciones, correcta });
      }
    },
  },
};
